...
# Helper function to get data based on disease
def helper(dis):
...
diseases_list = {15: 'Fungal infection', 4: 'Allergy', 16: 'GERD', 9: 'Chronic cholestasis',
                 ...
                 31: 'Osteoarthritis', 5: 'Arthritis', 0: '(vertigo) Paroymsal Positional Vertigo',
    ...
    if request.method == 'POST':
        ...
        if not symptoms:
            ...
            if invalid_symptoms:
                ...
                rec_diet = rec_diet if rec_diet else []
                ...
                return render_template('index.html', predicted_disease=predicted_disease, dis_des=dis_des,
                                       ...
                                       diets=rec_diet, workouts=workout, symptoms_list=symptoms_list)
